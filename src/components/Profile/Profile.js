    ...
    <div className="profile">
      ...
      <div className="profile-card">
        ...
        <div className="text-wrap">
          ...
          <p>
            Now I advice clubs and federations about sponsorships, social media
            and digitalization in general. I support the Nietlebener SV as a
            player and as the social media manager.
          </p>
        </div>
      </div>
    </div>
